...
| advancedGenerator+run-match+font-edits | PASS | txns=22 runs=348 linked=72 edits=59 |
| pymupdf-replace (bank-desc) | PASS | mode=table+geometry edits=22 material=full-ledger |
...
| run-match | PASS | fields=90 linked=72 paired=72 |
